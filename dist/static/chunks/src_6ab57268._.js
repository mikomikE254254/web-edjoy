...
function ProductPurchaseForm(param) {
    ...
    const handleBuyViaWhatsApp = ()=>{
        ...
        const message = "Hi Eddjoys, I would like to order ".concat(quantity, " of the ").concat(product.name).concat(colorText, " in Size ").concat(selectedSize, ". Price: Ksh ").concat((product.price * quantity).toFixed(2), ".");
...
_s(ProductPurchaseForm, "7iCWu7AF622miwd0ocO2q3bq7Wg=", false, function() {
    return [
